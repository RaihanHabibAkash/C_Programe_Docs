...
{
    int row,col;
    scanf("%d %d",&row,&col);   // রো এবং কলাম সংখ্যা ইনপুট নেওয়া হচ্ছে।
    int a[row][col];            // ইনপুট নেওয়া রো এবং কলাম দিয়ে 2D এরে ডিক্লেয়ার করা হচ্ছে।
    for(int i=0;i<row;i++)
    {
        for(int j=0;j<col;j++)
        {
            scanf("%d",&a[i][j]);  // নেস্টেড লুপ চালিয়ে ইনপুট নেওয়া হচ্ছে। 
        }
    }
    return 0;
}
